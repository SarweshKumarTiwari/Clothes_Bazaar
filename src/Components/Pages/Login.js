...
export default function Login() {
  ...
  return (
    <div className="max-w-lg mx-auto my-5 bg-gray-100 p-8 rounded-xl shadow shadow-slate-300">
      <ToastContainer />
      <h1 className="text-4xl font-medium">Login</h1>
      <div className="my-5">
        <button className="w-full text-center py-3 my-3 border flex space-x-2 items-center justify-center border-slate-400 rounded-lg text-slate-700 hover:border-slate-600 hover:text-slate-900 hover:shadow transition duration-150">
      ...
      <form action="" className="my-3">
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex flex-row justify-between">
            <div>
              <Link to='/forgotpassword' className="font-medium text-gray-600">Forgot Password?</Link>
            </div>
          </div>
          ...
          <p className="text-center">Not registered yet? <Link to="/signup" className="text-gray-600 font-medium inline-flex space-x-1 items-center"><span>Register now </span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
