...
export default function IsAuthSeller(props) {
    ...
    return (
        <ul className='space-y-4'>
            ...
            <li className={props.pathname === '/selleradditems' ? "pl-4 bg-gray-300 rounded-md" : ""}>
                <Link
                    to="/selleradditems"
            ...
            <li className={props.pathname === '/' ? "pl-4 bg-gray-300 rounded-md" : ""}>
                <Link
                    to="/"
                    className="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400"
                    aria-label="Sign up"
